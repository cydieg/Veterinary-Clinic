                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="region{{ $user->id }}">Region:</label>
                                                <select class="form-control" id="region{{ $user->id }}" name="region" required>
                                                    <!-- Options will be dynamically populated by JavaScript -->
                                                </select>
                                                <input type="hidden" name="region_text" id="region-text{{ $user->id }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="province{{ $user->id }}">Province:</label>
                                                <select class="form-control" id="province{{ $user->id }}" name="province" required>
                                                    <!-- Options will be dynamically populated by JavaScript -->
                                                </select>
                                                <input type="hidden" name="province_text" id="province-text{{ $user->id }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="city_text" id="city-text{{ $user->id }}">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="barangay{{ $user->id }}" name="barangay" required>
                                                    <!-- Options will be dynamically populated by JavaScript -->
                                                </select>
                                                <input type="hidden" name="barangay_text" id="barangay-text{{ $user->id }}">
                                                <div class="invalid-feedback">
