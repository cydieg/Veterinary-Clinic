...
<head>
    ...
    <style>
        ...
        .navbar li {
            display: inline;
            margin-left: 10px; /* Adjust this value to add space between items */
        }
        #navigation {
        display: flex;
        align-items: center;
    ...
    .navbar li {
        display: inline;
        margin-right: 20px; /* Adjust this value to add space between items */
    }
            ...
            <div class="modal-body">
                ...
                <form id="addToCartForm" action="{{ route('cart.add') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-center" id="quantity" name="quantity" oninput="calculateTotal()" value="1">
                    </div>
