    ...
    <body>
        <div class="container">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm add-quantity-btn"
                                            ...
                                            data-item-id="{{ $item->id }}">Add Quantity</button>
                                        <!-- Update action to redirect to audit page -->
                                        <a href="{{ route('inventory.audit.show', ['id' => $item->id]) }}"
                                            class="btn btn-primary btn-sm">Audit</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="addQuantityForm" method="POST"
                                action="{{ route('inventory.addquantity', ['id' => ':id']) }}">
                                @csrf
                                <div class="form-group">
            ...
            @if ($showLowInventoryAlert)
                <div class="modal fade" id="lowInventoryModal" tabindex="-1" aria-labelledby="lowInventoryModalLabel"
                    aria-hidden="true" data-backdrop="static">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <p>Your product '{{ $lowInventoryProduct->name }}' has only 10 items left. Please add more
                                    quantity.</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
