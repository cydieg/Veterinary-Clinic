    ...
    public function store(Request $request)
{
    ...
    // Add the actual names of region, province, city, and barangay to validated data
    ...
    $address = $validatedData['region'] . ', ' . $validatedData['province'] . ', ' . $validatedData['city'] . ', ' . $validatedData['barangay'];
